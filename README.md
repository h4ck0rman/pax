...
The signed-out page is a landing page: a panel of climbing vines beside the
wordmark, a short description of what Pax offers, and one Google button. The vines
are generated by `scripts/generate_vine_art.py` and drawn inline, so the page
fetches nothing from anywhere else.
